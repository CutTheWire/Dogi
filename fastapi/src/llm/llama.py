...
# 모듈 경로 설정 - domain 모듈을 인식할 수 있도록 경로 추가
current_dir = Path(__file__).parent  # llm 디렉토리
src_dir = current_dir.parent         # src 디렉토리
...
from domain import base_config, vector_client
...
def build_llama3_prompt_with_rag(character_info: base_config.OfficePrompt, 
...
class LlamaOfficeModel:
    """
    RAG 기능을 갖춘 GGUF 포맷 Meta-Llama-3.1-8B-Claude 모델 클래스
    ...
    def __init__(self, enable_rag: bool = True) -> None:
        ...
        self.model_path = "./fastapi/models/Meta-Llama-3.1-8B-Claude.Q4_0.gguf"
