'''
파일은 LlamaModel, base_config.OfficePrompt 클래스를 정의하고 llama_cpp_cuda를 사용하여,
...
class LlamaModel:
    ...
    def __init__(self, enable_rag: bool = True) -> None:
        ...
        if self.enable_rag:
            ...
            try:
                self.vector_search = vector_client.VectorSearchHandler()
...
if __name__ == "__main__":
    ...
    def run_comprehensive_test():
        ...
        try:
            ...
            # 모델 초기화 (RAG 비활성화)
            model = LlamaModel(enable_rag=False)
